-- Script simplificado para criar a tabela caracterizacaoBarragem
-- Sem foreign keys (podem ser adicionadas depois se necessário)
...
BEGIN
  CREATE TABLE dbo.caracterizacaoBarragem (
    ...
    sincronizadoComHidro BIT NOT NULL DEFAULT 0,
